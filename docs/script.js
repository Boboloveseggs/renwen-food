...
const DISHES = [
  ...
  },
  {
    ...
    source: "《金瓶梅》第三十四回",
    scene: "柳蒸糟鲥鱼和王瓜拌辽东金虾出现在同一场酒席里。西门庆陪应伯爵在莫染轩吃酒，前面先上四碟案鲜、四碗下饭，后面才用里外青花白地磁盘盛出一盘柳蒸糟鲥鱼。原文形容它馨香美味、入口而化、骨刺皆香。",
    intro: "鲥鱼是时鲜名物，季节性强，离水易坏，能吃到本就不易。再以香糟蒸制，鲜味里带酒香，软嫩细腻，是这一席中最有身份感的一道菜。",
    books: "《金瓶梅》饮食大观更重视这道菜背后的“应氏吃法”。它写应伯爵得到西门庆所送鲥鱼后，把鱼看作稀罕物，细细切块，慢慢享用，也借此写出帮闲人物的得意和小家子气。《金瓶梅饮食谱》则按“柳蒸糟鲥鱼”复原，强调鲥鱼、香糟、芽姜、猪板油、鸡油、料酒等配合，突出入口而化、糟香浓郁的口感。",
    story: "这道菜不是一开席就上，而是放在后面压席。前面的冷碟和下饭已经铺开排场，糟鲥鱼一出，才是真正的好东西。它说明西门庆请客不是只求吃饱，而是要让客人觉得稀罕、觉得体面。应伯爵这样的人，最懂得从一盘鱼里看主人的财力、门路和交情。",
    method: "鲥鱼洗净改刀，略以盐、酒腌制，铺姜丝、葱丝和香糟，上笼清蒸。可加入少量油脂增润，出锅后淋原汁，使鱼肉细嫩、糟香入味。",
    ingredients: "鲥鱼、香糟、芽姜、葱、黄酒、猪板油、鸡油。",
    aroma: "鱼鲜先起，酒糟随后，姜丝把腥气压下去。",
    share: "柳蒸糟鲥鱼一上桌，西门府的排场才真正显出来。",
  },
  {
    number: "DISH 06",
    title: "八宝攒汤",
